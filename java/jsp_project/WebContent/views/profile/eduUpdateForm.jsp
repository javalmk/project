            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form action="eduUpdate.do" id="form_advanced_validation" method="POST" novalidate>
                                <div class="form-group form-float">
                                    <div class="form-line">
                                    	<input type="hidden" name="id" value="${dto.id}" />
                                    	<input type="hidden" name="num" value="${dto.num }" />
                                        <input value="${dto.place}" placeholder="학교명 또는 기관명" type="text" class="form-control" name="place" maxlength="10" minlength="3" required>
                                    </div>
                                    <div class="help-info">* 필수 작성</div>
                                </div>
                                <div class="form-group form-float">
                                    <div class="form-line">
                                    	<input value="${dto.major}" placeholder="전공" type="text" class="form-control" name="major" maxlength="50" minlength="3" required>
                                    </div>
                                    <div class="help-info">* 필수 작성</div>
                                </div>
                                 <div class="form-group form-float">
                                    <div class="form-line">
                                    	<input value="${dto.edu_exp}" placeholder="교육내용" type="text" class="form-control" name="edu_exp" maxlength="500" minlength="3" required>
                                    </div>
                                    <div class="help-info">* 필수 작성</div>
                                </div>
                                 <div class="form-group form-float">
